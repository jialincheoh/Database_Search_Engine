                ...
                if len(element) > 1:
                    if element[0] == 'C':
                        if element[1] in ("A", "L", "R", "O", "U", "D", "S", "E"):
                            if not metal:
                                print("INFO: %s found and replaced with C (index %s)." 
                        ...
                        if element[1] in ("E", "F", "G"):
                            if not metal:
                                print("INFO: %s found and replaced with H (index %s)." 
                                    % (element, line[6:11].strip()))
                                element = "H"
                        else:
                            element = "H"
                        ...
                        if element[1] in ("E", "A", "I", "B"):
                            if not metal:
                                print("INFO: %s found and replaced with N (index %s)."
                                    % (element, line[6:11].strip()))
                                element = "N"
                        else:
                            element = "N"
...
def usage(cmd):
    print("""
Converts a input.pdb file in input.xyz.

Syntax:  pdb2xyz input1.pdb [input2.pdb [input3.pdb [...]]]
""")
